...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/uhstudio",
      };
  ...
  const projectUrl = `https://umarhdii.my.id/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Umar Hadi Wijaya</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Umar Hadi Wijaya — Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Umar Hadi Wijaya`}
        />
        <meta
