...
const WORDS = ["Informatic Engineer", "Tech Enthusiast"];
const TECH_STACK = ["PHP", "Javascript", "Laravel","CodeIgniter", "Tailwind"];
const SOCIAL_LINKS = [
  {
    icon: Github,
    link: "https://github.com/uhstudio",
    label: "GitHub Profile",
  },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/umarhdii/",
    label: "LinkedIn Profile",
  },
  {
    icon: Instagram,
    link: "https://www.instagram.com/umarhdii/",
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Umar Hadi Wijaya — Web Developer</title>
        <meta
          name="description"
          content="Website resmi Umar Hadi Wijaya, Web Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://umarhdii.my.id/" />
        <meta property="og:title" content="Umar Hadi Wijaya — Web Developer" />
        <meta
          property="og:description"
          content="Website resmi dan portofolio Umar Hadi Wijaya, Web Developer."
        />
        <meta property="og:url" content="https://umarhdii.my.id/" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json">{`
          {
            "@context": "https://schema.org",
            "@type": "Person",
            "name": "Umar Hadi Wijaya",
            "jobTitle": "Web Developer",
            "url": "https://umarhdii.my.id/",
            "sameAs": [
              "https://github.com/uhstudio",
              "https://www.linkedin.com/in/umarhdii/",
              "https://www.instagram.com/umarhdii/"
            ]
          }
        `}</script>
      </Helmet>
