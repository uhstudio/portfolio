...
const AboutPage = () => {
  ...
  const { totalProjects, YearExperience } = stats;
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Undergraduate Informatics Engineering at Muria Kudus University,
              with expertise in Software Engineering and Web Development.
              Experienced in building web-based systems, system analysis, and
              applying structured software development approaches.
            </p>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/file/d/1h1Aly3XdaAY6bsMbK7RKbue6Abg-Lbml/view?usp=sharing"
